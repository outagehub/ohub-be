...
# URL to scan
url = "https://services.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tilemap/11/752/568/8/8?f=json" #pretty sure its this one

# File to save the original response
original_file = "Grimsby_original_updatepushpin.txt"
new_file = "Grimsby_new_updatepushpin.txt"
