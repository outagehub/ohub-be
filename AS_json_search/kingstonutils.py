...
# URL to scan
url = "https://power.utilitieskingston.com/Outages/Home/UpdatePishpin"

# File to save the original response
original_file = "kingstonutil_original_updatepushpin.txt"
new_file = "kingstonutil_new_updatepushpin.txt"
